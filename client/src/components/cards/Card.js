...
function Card({ title, budget_name, cardtype, spent, balance, expiry }) {
  ...
  return (
    <div className="w-1/4 rounded-lg shadow-lg p-5 m-4">
      <div className="flex flex-row justify-between">
        ...
        <div className="w-10 h-auto">
          {cardtype == "Burner" ? (
            <img src={require("../../images/burner.png")} />
          ) : (
            <img src={require("../../images/subscription.png")} />
          )}
        </div>
      </div>
      ...
      <div className=" flex flex-row w-full mt-3">
        <div
          ...
          className="bg-green-700 h-3 rounded-l-lg"
        ></div>
        <div
          style={{ width: `${balancepercent}%` }}
          className="bg-pink-700 h-3 rounded-r-lg"
        ></div>
      </div>
      <div className="flex flex-col">
        <div className="flex flex-row justify-between items-center mt-3">
          <div className="flex flex-row items-center">
            <div className="w-2 h-2 rounded-lg bg-green-700 mr-2"></div>
        ...
        <div className="flex flex-row justify-between items-center mt-2">
          <div className="flex flex-row items-center">
            <div className="w-2 h-2 rounded-lg bg-pink-700 mr-2"></div>
